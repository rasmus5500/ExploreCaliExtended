...
import com.example.ec.web.JwtRequestHelper;
...
public class TourRatingControllerTest {
    ...
    public void createTourRating() throws Exception {
        restTemplate.exchange(TOUR_RATINGS_URL, HttpMethod.POST, new HttpEntity(ratingDto, jwtRequestHelper.withRole("ROLE_CSR")), Void.class);
    ...
    public void createManyTourRatings() throws Exception {
        restTemplate.exchange(TOUR_RATINGS_URL + "/" + SCORE + "?customers=" + CUSTOMER_ID, HttpMethod.POST, new HttpEntity(ratingDto, jwtRequestHelper.withRole("ROLE_CSR")), Void.class);
