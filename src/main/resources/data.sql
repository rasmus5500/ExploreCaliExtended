...
insert into tour  (tour_package_code, title, description, blurb, bullets, difficulty, duration, price, region, keywords) values
    ...
    (
        ...
        'Situated in the midst of rolling hills and vineyards, Paso Robles has been renowned for thermal springs water. The Salinan Indians, the most historical inhabitants of the area, knew this area as â€œThe Springsâ€ and found relief from various ailments in the therapeutic waters, which arise naturally at 117 degrees. At River Oaks Hot Springs Spa, you have access to these springs while surrounded by a world-class spa facility. Choose from a private indoor, open-air tub or an outdoor hillside tub, and select from among their massage or face and skin therapy services. Spend the night at the Orchard Hill Bed & Breakfast and spend the following day wandering the wineries or antiquing in the quaint downtown.',
...
insert into tour  (tour_package_code, title, description, blurb, bullets, difficulty, duration, price, region, keywords) values
                                                                                                                             ...
                                                                                                                             (
                                                                                                                                 ...
                                                                                                                                 'This year only, weâ€™re also offering a special package that allows serious cyclists to follow behind a competitor in the AMGEN bike race, a race that mimics the conditions in the Tour de France. Spots are limited so reserve your seat now!',
